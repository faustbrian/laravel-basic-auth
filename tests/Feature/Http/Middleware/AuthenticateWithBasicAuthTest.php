...
function getRequest(?string $user, ?string $password): \Symfony\Component\HttpFoundation\Request
{
    return Request::create('http://localhost', \Symfony\Component\HttpFoundation\Request::METHOD_GET, [], [], [], [
        'PHP_AUTH_USER' => $user,
